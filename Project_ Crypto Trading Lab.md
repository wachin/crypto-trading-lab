...
├── upstream/
│   └── metadata
├── crypto-trading-lab.install
├── crypto-trading-lab.manpages
├── crypto-trading-lab.desktop
└── crypto-trading-lab.metainfo.xml
```
...
Create a Spanish translation later at:

```text
docs/es/developers/dependencias-debian.md
```
...
├── AppRun
├── crypto-trading-lab.desktop
├── crypto-trading-lab.appdata.xml
└── build-appimage.sh
```
...
├── 00-start-here.md
├── 01-what-is-money.md
├── 02-what-is-digital-money.md
├── 03-what-is-cryptocurrency.md
├── 04-what-is-bitcoin.md
├── 05-what-is-a-blockchain.md
├── 06-wallets-explained.md
├── 07-private-keys-and-seed-phrases.md
├── 08-what-is-an-exchange.md
├── 09-centralized-and-decentralized-exchanges.md
├── 10-spot-markets.md
├── 11-trading-pairs.md
├── 12-bid-ask-and-spread.md
├── 13-order-books.md
├── 14-market-orders.md
├── 15-limit-orders.md
├── 16-fees.md
...
├── 18-liquidity.md
├── 19-volatility.md
├── 20-candlestick-charts.md
├── 21-ohlcv-data.md
├── 22-timeframes.md
├── 23-support-and-resistance.md
├── 24-trends.md
├── 25-technical-indicators.md
├── 26-moving-averages.md
├── 27-rsi.md
├── 28-macd.md
├── 29-bollinger-bands.md
├── 30-atr-and-volatility.md
├── 31-what-is-a-trading-strategy.md
├── 32-risk-management.md
├── 33-position-sizing.md
├── 34-stop-loss.md
├── 35-take-profit.md
├── 36-drawdown.md
├── 37-paper-trading.md
├── 38-backtesting.md
├── 39-look-ahead-bias.md
├── 40-overfitting.md
├── 41-training-validation-and-testing.md
├── 42-why-backtests-can-lie.md
├── 43-why-paper-trading-is-different.md
├── 44-api-keys.md
├── 45-api-key-security.md
├── 46-common-scams.md
├── 47-emotional-trading.md
├── 48-common-beginner-mistakes.md
├── 49-when-not-to-trade.md
├── 50-learning-roadmap.md
└── glossary.md
```
...
docs/en/user-guide/
├── 00-welcome.md
├── 01-installing-on-debian.md
├── 02-first-launch.md
├── 03-interface-tour.md
├── 04-changing-the-language.md
├── 05-using-the-learning-center.md
├── 06-importing-csv-data.md
├── 07-opening-a-market-chart.md
├── 08-reading-a-candlestick-chart.md
├── 09-adding-an-indicator.md
├── 10-creating-a-simple-strategy.md
├── 11-running-your-first-backtest.md
├── 12-understanding-backtest-results.md
├── 13-starting-paper-trading.md
├── 14-placing-a-simulated-order.md
├── 15-reading-your-portfolio.md
├── 16-using-risk-profiles.md
├── 17-using-the-kill-switch.md
├── 18-exporting-a-report.md
├── 19-backing-up-your-data.md
├── 20-troubleshooting.md
└── 21-safe-next-steps.md
```
...
After the English documentation is created and reviewed, create Spanish translations under:
...
The first English beginner guide must be:
...
The first glossary file must be:
